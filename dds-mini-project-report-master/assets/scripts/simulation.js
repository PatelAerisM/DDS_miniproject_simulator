...
let stuckAtarray = ['N/A', 'A SA0', 'A SA1', 'B SA0', 'B SA1', 'C SA0', 'C SA1', 'D SA0', 'D SA1', 'E SA0', 'E SA1'];
...
function addResult() {
    let ogoutput = result[switches[0].dataset.value][switches[1].dataset.value][switches[2].dataset.value];
    let html = `
                     <tr style="background-color:${ogoutput == output ? '#96ff96' : '#f88570'}">
